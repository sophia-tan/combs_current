...
class Comb(ContextDecorator):
    ...
    def __init__(self, ifg_sele_dict, ifg_seq_str=None, **kwargs):
        """param kwargs: """
        _cwd = os.getcwd()
        ...
        #need fn that checks that ifg_selection_info_dictionary is formatted correctly
    ...
    def __enter__(self):
        fieldnames_ifg_pdb = ['iFG_count', 'pdb', 'resname', 'resnum', 'resindex', 'chid', 'atom_names', 'sequence',
        ...
        fieldnames_vdm_pdb = ['iFG_count', 'vdM_count', 'resname', 'resnum', 'resindex', 'chid', 'atom_names',
                              'sequence', 'frag_length', 'rel_resnums', 'sec_struct_dssp', 'sec_struct_phi_psi',
                              'sec_struct_phi_psi_frag', 'rotamer']
        ...
        fieldnames_ifg_atom_density = ['iFG_count', 'cBeta_density', 'heavy_atom_density_5A', 'heavy_atom_density_10A',
        ...
        fieldnames_vdm_sasa_info = ['iFG_count', 'vdM_count', 'vdM_sasa_full_residue', 'vdM_sasa_dssp_full_residue',
