...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/phenyl/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/phenyl/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'PHE': 'CG CD1 CD2 CE1 CE2 CZ'}
kwargs = {'file_tag': 'phenyl',
