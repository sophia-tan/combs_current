...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/backboneCO/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/backboneCO/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'ANY': 'C O'}
kwargs = {'file_tag': 'backboneCO',
          'radius1': 3.2,
          'radius2': 3.5,
          'ifg_seq_str': '.',
