...
sample.set_ligand_ifg_correspondence(relvdm_carboxylate1, 'C1 C1 O2 O2', 'OE2 OE1 OE2 OE1')
sample.set_ligand_ifg_correspondence(relvdm_carboxylate2, 'C1D C1D O2D O2D', 'OE2 OE1 OE2 OE1')
sample.set_ligand_ifg_correspondence(relvdm_carboxylate3, 'C3 C3 O3 O3', 'OE2 OE1 OE2 OE1')
sample.set_ligand_ifg_correspondence(relvdm_carboxylate4, 'C3D C3D O4 O4', 'OE2 OE1 OE2 OE1')
...
sample.find_ligand_cst_hotspots(tol=.2)
...
sample.set_lig_ifg_dict(relvdm_carboxylate2, 'C2D C1D O2 O1D')
sample.set_lig_ifg_dict(relvdm_carboxylate3, 'C4 C3 O2 O3')
