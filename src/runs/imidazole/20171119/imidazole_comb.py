...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/imidazole/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/imidazole/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'HIS': 'CG CD2 NE2 CE1 ND1'}
kwargs = {'file_tag': 'imidazole',
