...
sample.poi = pr.parsePDB(poi_path + '2x9dH.pdb')
site = pr.parsePDB(site_path + '2x9d.pdb')
...
sample.bs_residues = [(sel.getResnums()[0], sel.getChids()[0]) for sel in sels]
...
outdir = '/Users/npolizzi/Projects/combs/results/apixaban/20171025/2x9d/ppc/'
try:
    os.makedirs(outdir)
except:
    pass
