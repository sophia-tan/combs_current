...
sample.poi = pr.parsePDB(poi_path + '2ykz_proteinH.pdb')
# site = pr.parsePDB(site_path + '2ykz_protein.pdb')
...
resis = [9,12,13,16,17,19,20,23,24,48,49,52,55,56,58,59,65,66,67,68,69,72,79,82,83,86,112,113,115,116,119,120,123]
...
outdir = '/Users/npolizzi/Projects/combs/results/apixaban/20171025/2ykz_protein/ppc/'
try:
    os.makedirs(outdir)
except:
    pass
