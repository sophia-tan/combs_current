...
sample = combs.Sample()
sample.poi = pr.parsePDB(pdb_path + '20171022/helix_template.pdb')
sample.bs_residues = list(zip([6, 9, 10, 12, 13, 14, 16, 17, 19, 20, 21],
...
print('clustering...')
mems, cents = combs.Cluster.cluster_adj_mat_gt(adj_mat, gt=10)
...
# relvdm_preproline_carbonyl._all_scs = functools.reduce(lambda a, b: np.vstack((a, b)),
#                                       [val for val in relvdm_preproline_carbonyl._scs.values()])

outdir = '/Users/npolizzi/Projects/combs/results/apixaban/20171022/'
try:
    os.makedirs(outdir)
except:
    pass
...
# relvdm_carboxamide._all_scs = functools.reduce(lambda a, b: np.vstack((a, b)),
#                                       [val for val in relvdm_carboxamide._scs.values()])
...
sample.find_ligand_cst_cliques(relvdms, **{'maxlen': 2, 'atol1': 1.4, 'atol2': 1.4, 'pc': 1})

# sample.poi = None
# sample.rois = None
# outpath = '/Users/npolizzi/Projects/combs/results/apixaban/20171022/'
