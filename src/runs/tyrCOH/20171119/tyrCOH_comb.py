...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/tyrCOH/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/tyrCOH/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'TYR': 'CZ OH'}
kwargs = {'file_tag': 'tyrCOH',
