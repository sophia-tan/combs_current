...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/pyrrolidine/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/pyrrolidine/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'PRO': 'CD CG CB'}
kwargs = {'file_tag': 'pyrrolidine',
