...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/preproline_carbonyl/20171119/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/preproline_carbonyl/20171119/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {1: {'ANY': 'C O'}, 2: {'PRO': 'N'}}
kwargs = {'file_tag': 'preprolineCO',
          'ifg_seq_str': '.P',
