...
try:
    output_dir_pdb = '/Users/npolizzi/Projects/combs/results/glycine/20171013/vdM'
    os.makedirs(output_dir_pdb)
except:
    pass

try:
    output_dir_csv = '/Users/npolizzi/Projects/combs/results/glycine/20171013/csv'
    os.makedirs(output_dir_csv)
except:
    pass

ifg_dict = {'GLY': 'C O CA N'}
kwargs = {'file_tag': 'glycine',
