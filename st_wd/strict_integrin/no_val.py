...
AAs=['R671', 'I673', 'N753','F755','S758', 'E785','H787','R900','L959']
activation = np.array([0.54,0.23,0.37,0.4,0.64,0.47,0.17,0.31,0.05])
sortedactivation = sorted(activation)
new_order = [np.where(activation==sortedactivation[ix])[0][0] for ix,i in enumerate(activation)]

if method == 'pdb':
    calc = [6.702562613105745e-05, 0.0007233614291105799, 0.006805014221004951, 0.0020855868825923533, 0.00864282755764186, 0.01088135593220339, 0.005313418217433888, 0.00011155982953658047, 8.45809016324114e-05] # BBorSc .5
