...
def rmsd_filter(method,cutoff):
    ...
    for targetres in sorted(set(targetresis)):
        ...
        num_ifg_vdm_nums_list.append(np.log10(rawcounts/all_poss_intrxn))
        freq_method_list.append(np.log10(rawcounts/freq_method))
        interacting_method.append(np.log10(rawcounts/interacting))
        #print(rawcounts,all_poss_intrxn,freq_method,interacting)
