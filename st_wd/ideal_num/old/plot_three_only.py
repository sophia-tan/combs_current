...
labels = ['# hbonds iFG makes', '# vdMs iFGs have vdw contacts with', '# vdMs iFGs have polar contacts with','xx', '# atoms on vdMs that hbond with iFG', '# Ca atoms on vdMs that hbond with iFG', '# atoms on vdMs that make vdw contacts with iFG', '# atoms on vdMs that make polar contacts with iFG']  
...
plot(0,0,totalhbond,0)
plot(1,0,vdw_contacts_vdmlevel,1)
plot(2,0,polar_contacts_vdmlevel,2)
