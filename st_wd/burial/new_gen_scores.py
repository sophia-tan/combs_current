# just meant for testing. delete when done bc this is sloppy
...
db_aai_freq = pkl.load(open('../Lookups/burial_scores/new_db_burial_scores.pkl','rb'))
...
for _bin in index: #_bin is the upperbound (doesn't include)
    ...
    for aa in AAs:
        ...
        freq_aai_db = db_aai_freq.loc[_bin,aa]
        if frac_aai_bin == 0:
            frac_aai_bin = 0.001
        if freq_aai_db == 0:
            freq_aai_db = 0.001
