...
activation = np.array([0.54,0.23,0.37,0.4,0.83,0.47,0.31])
...
if method == 'pdb':
    ...
    calc = [-0.56442745504304404, 0.33243845991560533, 0.74842252727210479, -0.36632714168594738, 0.70577371239096354, -0.98238370794390373, 0.31439395722196267]
