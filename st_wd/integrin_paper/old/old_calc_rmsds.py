    ...
    if resi[1:] == inputres:
        ...
        if len(interacting_resindices) > 0:
            ...
            for int_resindex in interacting_resindices: 
                ...
                score_interaction_and_dump(parsed,constants.three_letter_code[resn], \
                    int_res, target_res_atoms, int_res_atoms,method=method,targetresi=resi)
