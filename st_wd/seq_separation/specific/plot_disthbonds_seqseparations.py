...
all_distances = pkl.load(open('seq_separation_dist_hbonds_vdms_list.pkl','rb'))
plt.hist(all_distances, bins=49)
plt.title('raw counts for separations between vdms hbonding w/ same carboxamide (skip#10)')
