...
f.text(0.36,0.15,'$R^2=0.21$' ,size=12,multialignment='left',bbox={'edgecolor':'black','pad':3,'facecolor':'none','lw':1})
f.text(0.83,0.15,'$R^2=0.73$',size=12,multialignment='left',bbox={'edgecolor':'black','pad':3,'facecolor':'none','lw':1})
